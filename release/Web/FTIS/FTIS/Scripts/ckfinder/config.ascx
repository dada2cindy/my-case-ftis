...
<script runat="server">
    ...
    public override bool CheckAuthentication()
    {
        ...
        //bool check = this.Request.IsAuthenticated;
        //return check;
        return true;
    }
    ...
    public override void SetConfig()
    {
        ...
        BaseDir = FTISWeb.Utility.AppSettings.CKFinderBaseDir;

        // The base URL used to reach files in CKFinder through the browser.        
        BaseUrl = FTISWeb.Utility.AppSettings.CKFinderBaseUrl;
        ...
        FTISWeb.Helper.SessionHelper sessionHelper = new FTISWeb.Helper.SessionHelper();
        AccessControl acl = AccessControl.Add();
        if (this.Request.IsAuthenticated && sessionHelper.LoginUser != null)
        {
            acl.Role = "*";
            acl.ResourceType = "*";
            acl.Folder = "/";
