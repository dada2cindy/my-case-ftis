...
namespace FTIS.Service
{
    public interface IFTISService
    {
        ...
        /// <param name="newsId">識別碼</param>
        /// <returns>新聞</returns>
        News GetNewsByIdNoLazy(int newsId);
        #endregion
        ...
        /// <param name="linksId">識別碼</param>
        /// <returns>網路資源</returns>
        Links GetLinksByIdNoLazy(int linksId);
        #endregion
        ...
        /// <param name="greenFactoryId">識別碼</param>
        /// <returns>綠色工廠</returns>
        GreenFactory GetGreenFactoryByIdNoLazy(int greenFactoryId);
        #endregion
        ...
        /// <param name="applicationId">識別碼</param>
        /// <returns>企業社會責任</returns>
        Application GetApplicationByIdNoLazy(int applicationId);
        #endregion
        ...
        /// <param name="publicationId">識別碼</param>
        /// <returns>期刊</returns>
        Publication GetPublicationByIdNoLazy(int publicationId);
        #endregion
        ...
        /// <param name="questionId">識別碼</param>
        /// <returns>Q&A</returns>
        Question GetQuestionByIdNoLazy(int questionId);
        #endregion
        ...
        /// <param name="memberId">識別碼</param>
        /// <returns>會員</returns>
        Member GetMemberByIdNoLazy(int memberId);
        ...
        /// <param name="loginId">識別碼</param>
        /// <returns>會員</returns>
        Member GetMemberByLoginIdNoLazy(string loginId);
        #endregion
        ...
        /// <returns>會員</returns>
        EpaperEmail GetEpaperEmailByEmail(string email);
        #endregion
        ...
        /// <param name="normClassId">識別碼</param>
        /// <returns>標準/規範分類</returns>
        NormClass GetNormClassByIdNoLazy(int normClassId);
        #endregion
        ...
        /// <param name="newsId">識別碼</param>
        /// <returns>標準/規範資訊</returns>
        Norm GetNormByIdNoLazy(int normId);
        #endregion
        ...
        /// <param name="examinationId">識別碼</param>
        /// <returns>網站滿意度問卷</returns>
        Examination GetExaminationByIdNoLazy(int examinationId);
        #endregion
        ...
        /// <returns></returns>
        CountVO GetTodayCount(string barId);
        #endregion
    }
}
